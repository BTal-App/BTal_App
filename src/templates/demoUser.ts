...
// ── Planes builtIn (1..7 días) POBLADOS para modo DEMO ───────────────────
//
// En producción los builtIn arrancan vacíos (defaultUser.emptyPlan) · el
// user los rellena manualmente o con IA. Para el modo DEMO los poblamos
// con un esqueleto realista de ejercicios para que el invitado pueda
// explorar la tab Entreno y ver cómo se estructuran los planes.

type DemoEjer = readonly [string, string, string?]; // [nombre, series, desc?]

// Helper · construye un Ejercicio compacto.
function demoEj(t: DemoEjer) {
  return {
    nombre: t[0],
    desc: t[2] ?? '',
    series: t[1],
...
// Helper · construye un DiaEntreno con badges y ejercicios. Mantiene
// todos los campos requeridos del schema con defaults razonables.
function demoDia(
  titulo: string,
  descripcion: string,
  diaSemana: DayKey,
  badges: readonly [string, string?, string?],
  ejercicios: readonly DemoEjer[],
  opts?: { tiempo?: number; comentario?: string },
) {
  return {
    titulo,
    descripcion,
    tiempoEstimadoMin: opts?.tiempo ?? 60,
    diaSemana,
    badge: badges[0] as never,
    badgeCustom: '',
    badge2: (badges[1] ?? '') as never,
    badgeCustom2: '',
    badge3: (badges[2] ?? '') as never,
    badgeCustom3: '',
    ejercicios: ejercicios.map(demoEj),
...
const DEMO_PLAN_1DIAS = demoBuiltIn(1, [
  demoDia('Día 1 · Cuerpo completo', 'Full body · fuerza general', 'lun',
    ['fuerza', 'piernas', 'pecho'],
    [
      ['Sentadilla con barra', '3×8', 'Bajada controlada'],
      ['Press banca con barra', '3×8'],
      ['Remo con barra', '3×10'],
      ['Press militar mancuernas', '3×10'],
      ['Plancha frontal', '3×60s'],
    ],
    { tiempo: 75, comentario: 'Sesión única semanal · técnica primero, peso después.' },
  ),
]);

const DEMO_PLAN_2DIAS = demoBuiltIn(2, [
  demoDia('Día A · Tren superior', 'Pecho · Espalda · Hombros · Brazos', 'lun',
    ['pecho', 'espalda', 'hombros'],
    [
      ['Press banca con barra', '4×8'],
      ['Remo con barra', '4×10'],
      ['Press militar', '3×10'],
      ['Curl con mancuernas', '3×12', 'Alternando'],
    ],
    { tiempo: 65 },
  ),
  demoDia('Día B · Tren inferior', 'Piernas · Glúteos · Gemelos', 'jue',
    ['piernas', 'fuerza'],
    [
      ['Sentadilla con barra', '4×8'],
      ['Peso muerto rumano', '4×8'],
      ['Prensa 45°', '3×12'],
      ['Gemelos de pie', '3×15', 'Pausa arriba'],
    ],
    { tiempo: 70 },
  ),
]);

const DEMO_PLAN_3DIAS = demoBuiltIn(3, [
  demoDia('Día A · Empuje', 'Pecho · Tríceps · Hombros', 'lun',
    ['pecho', 'triceps', 'empuje'],
    [
      ['Press banca con barra', '4×8'],
  ...
  demoDia('Día B · Tirón', 'Espalda · Bíceps', 'mie',
    ['espalda', 'biceps'],
    [
      ['Dominadas', '4×6-8', 'Lastradas si puedes'],
      ['Remo con barra', '4×8'],
      ['Jalón al pecho', '3×10'],
  ...
  demoDia('Día C · Pierna', 'Tren inferior completo', 'vie',
    ['piernas', 'fuerza'],
    [
      ['Sentadilla con barra', '4×8'],
      ['Peso muerto rumano', '4×8'],
...
const DEMO_PLAN_4DIAS = demoBuiltIn(4, [
  demoDia('Día A · Tren superior fuerza', 'Pecho · Espalda · Hombros', 'lun',
    ['pecho', 'espalda', 'fuerza'],
    [
      ['Press banca con barra', '5×5'],
      ['Remo con barra', '5×5'],
      ['Press militar de pie', '4×6'],
    ],
    { tiempo: 70 },
  ),
  demoDia('Día B · Tren inferior fuerza', 'Sentadilla · Peso muerto · Pierna', 'mar',
    ['piernas', 'fuerza'],
    [
  ...
  demoDia('Día C · Tren superior hipertrofia', 'Volumen · Brazos · Hombros', 'jue',
    ['pecho', 'hombros', 'biceps'],
    [
      ['Press inclinado mancuernas', '4×10'],
      ['Remo polea', '4×10'],
      ['Elevaciones laterales', '4×12'],
      ['Curl barra · Tríceps polea', '3×12'],
    ],
    { tiempo: 60 },
  ),
  demoDia('Día D · Tren inferior hipertrofia', 'Cuádriceps · Femorales · Glúteos', 'vie',
    ['piernas', 'fuerza'],
    [
      ['Prensa 45°', '4×12'],
...
const DEMO_PLAN_5DIAS = demoBuiltIn(5, [
  demoDia('Día A · Empuje', 'Pecho · Tríceps · Hombros', 'lun',
    ['pecho', 'triceps', 'empuje'],
    [
      ['Press banca con barra', '4×8'],
  ...
  demoDia('Día B · Tirón', 'Espalda · Bíceps', 'mar',
    ['espalda', 'biceps'],
    [
      ['Dominadas', '4×6-8'],
      ['Remo con barra', '4×8'],
      ['Curl barra Z · Curl martillo', '4×10+10'],
    ],
    { tiempo: 60 },
  ),
  demoDia('Día C · Pierna', 'Tren inferior completo', 'mie',
    ['piernas', 'fuerza'],
    [
      ['Sentadilla con barra', '4×8'],
      ['Peso muerto rumano', '4×8'],
  ...
  demoDia('Día D · Tren superior accesorio', 'Volumen · Brazos · Core', 'jue',
    ['pecho', 'biceps', 'core'],
    [
      ['Aperturas en polea', '4×12'],
      ['Remo polea baja', '4×12'],
      ['Curl banco inclinado', '3×10'],
      ['Plancha frontal', '3×60s'],
    ],
    { tiempo: 55 },
  ),
  demoDia('Día E · Tren inferior accesorio', 'Glúteos · Femorales · Gemelos', 'vie',
    ['piernas', 'fuerza'],
    [
      ['Hip thrust con barra', '4×10'],
      ['Curl femoral', '4×12'],
      ['Zancadas alternas', '3×12'],
      ['Gemelos sentado', '4×15'],
    ],
    { tiempo: 60 },
  ),
...
const DEMO_PLAN_6DIAS = demoBuiltIn(6, [
  demoDia('Día A · Empuje (fuerza)', 'Pecho · Tríceps · Hombros', 'lun',
    ['pecho', 'triceps', 'fuerza'],
    [
      ['Press banca con barra', '5×5'],
      ['Press militar de pie', '4×6'],
  ...
  demoDia('Día B · Tirón (fuerza)', 'Espalda · Bíceps', 'mar',
    ['espalda', 'fuerza', 'biceps'],
    [
  ...
  demoDia('Día C · Pierna (fuerza)', 'Sentadilla · Peso muerto', 'mie',
    ['piernas', 'fuerza'],
    [
      ['Sentadilla con barra', '5×5'],
      ['Peso muerto convencional', '4×5'],
  ...
  demoDia('Día D · Empuje (hipertrofia)', 'Pecho · Hombros · Brazos', 'jue',
    ['pecho', 'hombros'],
    [
      ['Press inclinado mancuernas', '4×10'],
  ...
  demoDia('Día E · Tirón (hipertrofia)', 'Espalda · Bíceps · Antebrazos', 'vie',
    ['espalda', 'biceps'],
    [
      ['Jalón al pecho', '4×10'],
  ...
  demoDia('Día F · Pierna (hipertrofia)', 'Cuádriceps · Glúteos · Gemelos', 'sab',
    ['piernas', 'fuerza'],
    [
      ['Prensa 45°', '4×12'],
      ['Hip thrust con barra', '4×10'],
...
const DEMO_PLAN_7DIAS = demoBuiltIn(7, [
  demoDia('Día A · Empuje', 'Pecho · Tríceps · Hombros', 'lun',
    ['pecho', 'triceps'],
    [
      ['Press banca con barra', '4×8'],
  ...
  demoDia('Día D · Cardio + Core', 'Capacidad aeróbica + abdomen', 'jue',
    ['core', 'piernas'],
    [
      ['Cinta o bici · ritmo moderado', '40 min'],
      ['Plancha frontal · plancha lateral', '3×60s'],
      ['Hanging leg raise', '3×12'],
    ],
    { tiempo: 50, comentario: 'Sesión de recuperación activa · sin pesado.' },
  ),
  demoDia('Día E · Empuje (volumen)', 'Pecho · Hombros · Brazos', 'vie',
    ['pecho', 'hombros'],
    [
      ['Press inclinado mancuernas', '4×10'],
      ['Aperturas en polea', '3×12'],
  ...
  demoDia('Día F · Tirón (volumen)', 'Espalda · Bíceps · Antebrazos', 'sab',
    ['espalda', 'biceps'],
    [
      ['Jalón al pecho', '4×12'],
      ['Remo polea baja', '4×12'],
  ...
  demoDia('Día G · Pierna (volumen)', 'Glúteos · Femorales · Gemelos', 'dom',
    ['piernas', 'fuerza'],
    [
      ['Hip thrust con barra', '4×10'],
      ['Curl femoral', '4×12'],
...
const DEMO_BUILTIN_PLANES: Record<string, PlanEntreno> = {
  '1dias': DEMO_PLAN_1DIAS,
  '2dias': DEMO_PLAN_2DIAS,
  '3dias': DEMO_PLAN_3DIAS,
  '4dias': DEMO_PLAN_4DIAS,
  '5dias': DEMO_PLAN_5DIAS,
  '6dias': DEMO_PLAN_6DIAS,
  '7dias': DEMO_PLAN_7DIAS,
};
...
const DEMO_ENTRENOS: Entrenos = {
  ...
  planes: {
    // builtIn 1..7 días POBLADOS para demo · permite explorar cualquier
    // plan desde el strip y ver ejercicios realistas en cada día.
    ...DEMO_BUILTIN_PLANES,
