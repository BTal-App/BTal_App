          ...
          <div className="edit-fp-bg">
            <div className="edit-fp-card">
              ...
              <p className="onboarding-hint">
                ¿Dónde sueles comprar? La IA priorizará productos de esos supermercados (y su marca
                blanca) para facilitarte la compra. Déjalo vacío si no tienes preferencia.
              </p>
              <div className="onboarding-pills">
                {SUPERMERCADOS.map((s) => {
              ...
              <p className="settings-modal-text" style={{ margin: '0 0 4px' }}>
                Datos que la IA usará al generar tu programa. Todo opcional.
              </p>
